...
TOOLS = [
        ...
        "schema": [
            {
                ...
                "description": "Calculate pass success probability for each teammate. Input: passer_position ({x,y}), teammates (list of {player_id, position:{x,y}}), opponents (list of {player_id, position:{x,y}})",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "passer_position": {"type": "object", "description": "Passer position {x, y}"},
                        "teammates": {"type": "array", "description": "List of teammates with player_id and position"},
                        "opponents": {"type": "array", "description": "List of opponents with player_id and position"},
                    },
                    "required": ["passer_position", "teammates", "opponents"],
                },
            }
        ],
    },
    {
        ...
        "schema": [
            {
                "name": "evaluate_shot",
                "description": "Evaluate shot success probability and recommend aim point. Input: shooter_position ({x,y}), goalkeeper_position ({x,y}), team_side (HOME/AWAY), blocker_positions (list of {x,y})",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "shooter_position": {"type": "object", "description": "Shooter position {x, y}"},
                        "goalkeeper_position": {"type": "object", "description": "GK position {x, y}"},
                        "team_side": {"type": "string", "description": "HOME or AWAY"},
                        "blocker_positions": {"type": "array", "description": "List of blocker positions {x, y}"},
                    },
                    "required": ["shooter_position", "goalkeeper_position", "team_side"],
                },
            }
        ],
    },
        ...
        "schema": [
            {
                ...
                "description": "Grid-based open space finder by zone (attack/midfield/defense). Input: opponent_positions (list of {x,y}), zone (attack/midfield/defense), team_side (HOME/AWAY), my_position ({x,y})",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "opponent_positions": {"type": "array", "description": "List of opponent positions {x, y}"},
                        "zone": {"type": "string", "description": "Zone: attack, midfield, or defense"},
                        "team_side": {"type": "string", "description": "HOME or AWAY"},
                        "my_position": {"type": "object", "description": "My current position {x, y}"},
                    },
                    "required": ["opponent_positions", "team_side", "my_position"],
                },
            }
        ],
    },
        ...
        "schema": [
            {
                ...
                "description": "Rank opponent threats for defensive marking priority. Input: opponents (list of {player_id, position:{x,y}}), ball ({x,y, possession_player_id}), team_side (HOME/AWAY), my_position ({x,y})",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "opponents": {"type": "array", "description": "List of opponents with player_id and position"},
                        "ball": {"type": "object", "description": "Ball info: x, y, possession_player_id"},
                        "team_side": {"type": "string", "description": "HOME or AWAY"},
                        "my_position": {"type": "object", "description": "My current position {x, y}"},
                    },
                    "required": ["opponents", "ball", "team_side", "my_position"],
                },
            }
        ],
    },
